 ...
 */
public class RMIServerStoreData implements RMIinterface, Paxos, KVProcessor {
	 ...
	 * @throws IOExceptions
	 */
	public RMIServerStoreData(int server_id,
	...
	public void setMy_replicated_servers(
			final List<Paxos> my_replicated_servers) {
	...
	synchronized public String get(String the_key) throws RemoteException{
		myLog.normal("Server call: get (" + the_key + ")", true);
		//		System.out.println("Server call: get (" + the_key + ")");
		String value = my_KVStore.get(the_key);
		myLog.normal("key = " + the_key + " , value = " + value, true);
	...
	@Override
	public String prepare(float n, String v) throws RemoteException, InterruptedException {
		// TODO Auto-generated method stub
		return null;
	}
}