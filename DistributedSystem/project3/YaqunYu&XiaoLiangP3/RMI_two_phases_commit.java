...
public interface RMI_two_phases_commit extends Remote{
    ...
    */
    //functions from 1-pc   
    void twopcput(String thekey, String thevalue) throws RemoteException;
    
    void twopcget(String thekey) throws RemoteException;
    
    void twopcdelete(String thekey) throws RemoteException;
